...
analogInputPin = machine.ADC(26) # only one positional argument
                          # which is pin id
...
while True:
   # read raw analog signal value
    analogValue = machine.ADC.read_u16(analogInputPin)
    ...
    time.sleep_ms(100)# sleep is just for demonstration , vary it as per need
